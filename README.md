...
`npm install --save expo-otp-input`
or
`yarn add expo-otp-input`
...
```js
import OTPInputView from 'expo-otp-input'
...
## Support by Dominion Code https://kologojosias.com
